...
= После обновления плагина аватарки соцсетей заменились на шаблонные =

Проверьте, какой выбран пункт в панели администратора на странице *Настройки->Обсуждения* в списке *"Аватар по умолчанию"*.
Выберите пункт *uLogin*, чтобы подгружались аватарки соцсетей. Если пункт uLogin отсутствует - смотрите соответствующий раздел FAQ.
...
Для отображения аватарок соцсетей необходимо в панели администратора (Настройки->Обсуждения) в списке "Аватар по умолчанию" выбрать пункт uLogin.

Улучшена совместимость с плагином Simple:Press.
Исправлено кривое отображение аватарки гостя.
