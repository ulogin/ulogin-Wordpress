...
1. В выбранном разделе нажмите кнопку "Загрузить плагин".
1. Выберите скачанный файл, установите и активируйте плагин. Плагин заработает сразу после активации с настройками по умолчанию.
