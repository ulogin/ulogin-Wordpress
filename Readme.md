...
#### После обновления плагина аватарки соц.сетей заменились на шаблонные
Проверьте, какой выбран пункт в панели администратора на странице *Настройки->Обсуждения* в списке *"Аватар по умолчанию"*.
Выберите пункт *uLogin*, чтобы подгружались аватарки соц.сетей. Если пункт uLogin отсутствует - смотрите соответствующий раздел FAQ.

#### Отсутствует пункт uLogin в списке "Аватар по умолчанию"
Если Вы пользуетесь плагином *WP User Avatar*, то пункт uLogin в списке "Аватар по умолчанию" присутствовать не будет,
т.к. данный плагин написан таким образом, что мы не можем добавить в этот список свой пункт.
...
Если у вас uLogin не работает вместе с "WP User Avatar", просто переустановите uLogin, для этого достаточно его "Декактивировать" и "Активировать" заного.

## Upgrade Notice
Улучшено время хода пользователя в систему.
...
* Улучшена совместимость с плагином WP User Avatar. Появилась возможность установить собственный "Аватар по умолчанию" совместно с отображением аватар пользователей из соцсетей, если они зарегистрированны с помощью uLogin.
